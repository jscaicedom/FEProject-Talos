...
},{"process":"node_modules/process/browser.js"}],"node_modules/scrollmagic/scrollmagic/uncompressed/ScrollMagic.js":[function(require,module,exports) {
var define;
/*!
...
var sections = ['#home', '#about', '#about-video', '#team', '#portfolio', '#blog', '#contact'];
var headerSections = ['#home-button', '#about-button', '#about-video-button', '#team-button', '#portfolio-button', '#blog-button', '#contact-button'];
...
window.openMobileMenu = function () {
  ...
  (0, _jquery.default)(mobileNav).slideToggle(500, function () {
    mobileNav.classList.add('open-parent');
    items.classList.add('open');
  });
};

window.currentSlide = function (currentIndex) {
...
window.openQuestion = function (question) {
  closeAll();
  var text = question.querySelector('.question-text');

  if ((0, _jquery.default)(text).is(':visible')) {
    (0, _jquery.default)(text).slideUp();
  } else {
    (0, _jquery.default)(text).slideDown();
  }
};

function closeAll() {
  selectedQuestions.forEach(function (element) {
    (0, _jquery.default)(element.querySelector('.question-text')).slideUp();
  });
} // Testimonial Slider
...
showSlides(slideIndex); // build scenes
...
},{"jquery":"node_modules/jquery/dist/jquery.js","scrollmagic":"node_modules/scrollmagic/scrollmagic/uncompressed/ScrollMagic.js","svgxuse":"node_modules/svgxuse/svgxuse.js"}],"node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
//# sourceMappingURL=/FEProject-Talos.e31bb0bc.js.map