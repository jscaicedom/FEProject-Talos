...
new ScrollMagic.Scene({ triggerElement: "#home" })
    .setClassToggle("#home-buttom", "active__header") // add class toggle
    .addTo(controller);
new ScrollMagic.Scene({ triggerElement: "#about" })
    .setClassToggle("#about-buttom", "active__header") // add class toggle
    .addTo(controller);
new ScrollMagic.Scene({ triggerElement: "#about-video" })
    .setClassToggle("#about-video-buttom", "active__header") // add class toggle
    .addTo(controller);
new ScrollMagic.Scene({ triggerElement: "#team" })
    .setClassToggle("#team-buttom", "active__header") // add class toggle
    .addTo(controller);
new ScrollMagic.Scene({ triggerElement: "#portfolio" })
    .setClassToggle("#portfolio-buttom", "active__header") // add class toggle
    .addTo(controller);
new ScrollMagic.Scene({ triggerElement: "#blog" })
    .setClassToggle("#blog-buttom", "active__header") // add class toggle
    .addTo(controller);
new ScrollMagic.Scene({ triggerElement: "#contact" })
    .setClassToggle("#contact-buttom", "active__header") // add class toggle
    .addTo(controller);